#ifndef APPLETAVIALABILITYWIDGET_H
#define APPLETAVIALABILITYWIDGET_H
...
class AppletAvialabilityWidget : public MWidget
{
    Q_OBJECT
...
public:
    explicit AppletAvialabilityWidget(QGraphicsItem *parent = 0, Tp::AccountPtr account = Tp::AccountPtr());
    void init_state();
...
#endif // APPLETAVIALABILITYWIDGET_H
