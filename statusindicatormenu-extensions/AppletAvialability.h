#ifndef APPLETAVIALABILITY_H
#define APPLETAVIALABILITY_H
...
class AppletAvialability : public MWidget
{
    Q_OBJECT

public:
    explicit AppletAvialability(QGraphicsItem *parent = 0);
