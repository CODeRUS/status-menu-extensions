...
void AppletAvialabilityWidget::fakerupdate()
{
...
void AppletAvialabilityWidget::onChangingPresence(bool value)
{
    if (value)
...
void AppletAvialabilityWidget::onCurrentPresenceChanged(const Tp::Presence &presence)
{
...
void AppletAvialabilityWidget::onRequestedPresenceChanged(const Tp::Presence &presence)
{
...
QString AppletAvialabilityWidget::presenceToIconId(Tp::Presence presence)
{
...
void AppletAvialabilityWidget::mousePressEvent(QGraphicsSceneMouseEvent *ev)
{
    Q_UNUSED(ev);
...
void AppletAvialabilityWidget::mouseReleaseEvent(QGraphicsSceneMouseEvent *ev)
{
...
bool AppletAvialabilityWidget::event(QEvent *event)
{
