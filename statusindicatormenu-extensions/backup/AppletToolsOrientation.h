#ifndef APPLETTOOLSORIENTATION_H
#define APPLETTOOLSORIENTATION_H

#include "AppletToolsWidget.h"

class AppletToolsOrientation: public AppletToolsWidget
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.maemo.contextkit.Property")

public:
    explicit AppletToolsOrientation(QGraphicsObject *parent);
    virtual ~AppletToolsOrientation();
...
#endif // APPLETTOOLSORIENTATION_H
