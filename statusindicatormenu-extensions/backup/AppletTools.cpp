    ...
    MWidget(parent)
{
    ...
    AppletToolsBluetooth *bluetooth = new AppletToolsBluetooth(0);
    AppletToolsCellular *cellular = new AppletToolsCellular(0);
    AppletToolsFlashlight *flashlight = new AppletToolsFlashlight(0);
    AppletToolsRadio *radio = new AppletToolsRadio(0);
    AppletToolsPowersave *powersave = new AppletToolsPowersave(0);
    AppletToolsBrightness *brightness = new AppletToolsBrightness(0);
    AppletToolsUsb *usb = new AppletToolsUsb(0);
    AppletToolsBackgroundconnections *bgconn = new AppletToolsBackgroundconnections(0);
    AppletToolsOrientation *orientation = new AppletToolsOrientation(0);
    AppletToolsReboot *reboot = new AppletToolsReboot(0);

    m_list.append(bluetooth);
    m_list.append(cellular);
    m_list.append(flashlight);
    m_list.append(radio);
    m_list.append(powersave);
    m_list.append(brightness);
    m_list.append(usb);
    m_list.append(bgconn);
    m_list.append(orientation);
    m_list.append(reboot);
